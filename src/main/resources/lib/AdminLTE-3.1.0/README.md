...
Editor preferences are available in the [editor config](https://github.com/twbs/bootstrap/blob/main/.editorconfig) for easy use in com.common.gradleproject.common text editors. Read more and download plugins at <https://editorconfig.org/>.
